...
/* harmony import */ var _components_diagram_diagram_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/diagram/diagram.component */ "./src/app/components/diagram/diagram.component.ts");
...
/* harmony import */ var _directives_carousel_item_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./directives/carousel-item.directive */ "./src/app/directives/carousel-item.directive.ts");
/* harmony import */ var _components_dev_diagram_dev_diagram_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/dev-diagram/dev-diagram.component */ "./src/app/components/dev-diagram/dev-diagram.component.ts");
/* harmony import */ var _components_sys_diagram_sys_diagram_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/sys-diagram/sys-diagram.component */ "./src/app/components/sys-diagram/sys-diagram.component.ts");
...
/* harmony import */ var _components_resume_resume_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/resume/resume.component */ "./src/app/components/resume/resume.component.ts");
/* harmony import */ var _components_license_license_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/license/license.component */ "./src/app/components/license/license.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_diagram_diagram_component__WEBPACK_IMPORTED_MODULE_8__["DiagramComponent"],
                _components_carousel_carousel_component__WEBPACK_IMPORTED_MODULE_9__["CarouselComponent"],
                _components_carousel_carousel_component__WEBPACK_IMPORTED_MODULE_9__["CarouselItemElement"],
                _directives_carousel_item_directive__WEBPACK_IMPORTED_MODULE_10__["CarouselItemDirective"],
                _components_dev_diagram_dev_diagram_component__WEBPACK_IMPORTED_MODULE_11__["DevDiagramComponent"],
                _components_sys_diagram_sys_diagram_component__WEBPACK_IMPORTED_MODULE_12__["SysDiagramComponent"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _service_mail_mail_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../service/mail/mail.service */ "./src/app/service/mail/mail.service.ts");
/* harmony import */ var _model_mail_mail__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../model/mail/mail */ "./src/app/model/mail/mail.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ContactComponent = /** @class */ (function () {
    ...
    ContactComponent.prototype.processForm = function () {
        var _this = this;
        var mailToSend = Object(_model_mail_mail__WEBPACK_IMPORTED_MODULE_2__["createMail"])({ from: this.email, name: this.name, text: this.message });
        this.mailService.sendEmail(mailToSend).subscribe(function (data) {
            var mailGunResponse = data;
    ...
    ContactComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_service_mail_mail_service__WEBPACK_IMPORTED_MODULE_1__["MailService"]])
    ], ContactComponent);
...
module.exports = "<main class=\"Index\" data-controller=\"IndexFirstSectionHeight, Parallax, IndexNavigation\">\n  <section id=\"resume-header\" class=\"Index-page Index-page--has-image\"  data-parallax-original-element data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content  vba-alternate-block-style-container\">\n      <h1 align=\"center\">DEV SKILLS</h1>\n    </div>\n  </section>\n  <section *ngIf=\"!isMobile\" id=\"dev-diagram-content\" class=\"Index-page\" data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content\">\n      <div class=\"container\">\n        <div class=\"item\" id=\"devDiagram\"></div>\n      </div>\n    </div>\n  </section>\n  <section *ngIf=\"isMobile\" id=\"dev-diagram-content\" class=\"Index-page\" data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content \">\n      <div class=\"container\">\n        <carousel>\n          <ng-container *ngFor=\"let item of items;\">\n            <ng-container *carouselItem>\n              <div class=\"item\" id=\"{{item.id}}\"></div>\n            </ng-container>\n          </ng-container>\n        </carousel>\n      </div>\n    </div>\n  </section>\n</main>\n"
...
module.exports = "<main class=\"Index\" data-controller=\"IndexFirstSectionHeight, Parallax, IndexNavigation\">\n  <section id=\"resume-header\" class=\"Index-page Index-page--has-image\"  data-parallax-original-element data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content  vba-alternate-block-style-container\">\n      <h1 align=\"center\">EXTRA SKILLS</h1>\n    </div>\n  </section>\n  <section id=\"diagram-content\" class=\"Index-page\" data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content \">\n      <div class=\"container\">\n        <carousel>\n          <ng-container *ngFor=\"let item of items;\">\n            <ng-container *carouselItem>\n              <div class=\"item\" id=\"{{item.id}}\"> --@-- </div>\n            </ng-container>\n          </ng-container>\n        </carousel>\n      </div>\n    </div>\n  </section>\n</main>\n"
...
module.exports = ".Header [data-nc-element] {\n  padding: 10px 10px;\n}\n.Header-inner {\n  box-sizing: border-box;\n  padding-left: 50px;\n  padding-right: 50px;\n}\n.Header-inner {\n  box-sizing: border-box;\n  padding-left: 50px;\n  padding-right: 50px;\n}\n@media screen and (max-width: 960px) {\n  .Header-inner {\n    padding-left: 38px;\n    padding-right: 38px;\n  }\n}\n@media screen and (max-width: 768px) {\n  .Header-inner {\n    padding-left: 26px;\n    padding-right: 26px;\n  }\n}\n@media screen and (max-width: 740px) {\n  .Header-inner {\n    padding-left: 10px;\n    padding-right: 10px;\n  }\n}\n.Header-inner--bottom {\n  padding-top: 20px;\n}\n.Header.Header--bottom {\n  min-height: 112px;\n}\n.Header--bottom.Header--overlay {\n  box-sizing: border-box;\n  position: absolute;\n  top: 0;\n  left: 0;\n  background: transparent;\n  z-index: 1000;\n  width: 100%;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n}\n.Header-nav {\n  white-space: nowrap;\n  line-height: 1em;\n  font-family: Arial, Helvetica, sans-serif;\n  font-weight: 700;\n  font-size: 14px;\n  letter-spacing: 0em;\n  font-family: proxima-nova;\n  font-weight: 400;\n  font-style: normal;\n  font-size: 13px;\n  letter-spacing: 0.15em;\n  text-transform: uppercase;\n}\n.Header-nav-item {\n  display: inline-block;\n  vertical-align: middle;\n  color: #FFF;\n}\n@media only screen and (min-width: 950px) {\n  .Header-nav--primary .Header-nav-item,\n  .Header-nav--secondary .Header-nav-item {\n    padding: 12px 18px;\n    margin: 0.618em 1em;\n  }\n}\n@media only screen and (max-width: 950px) {\n  .Header .Header-nav .Header-nav-item {\n    font-size: 12px;\n    margin: 0 0.6em;\n  }\n}\n@media only screen and (min-width: 600px) and (max-width: 620px) {\n  .Header .Header-nav .Header-nav-item {\n    font-size: 12px;\n    margin: 0 0em;\n  }\n}\n.menu-spacer {\n  flex: 1 1 auto;\n}\n.white-icon {\n  color: white;\n}\n.mat-menu-panel.app-menu {\n  min-width: 112px;\n  max-width: 152px;\n  overflow: auto;\n  -webkit-overflow-scrolling: touch;\n  max-height: calc(100vh - 48px);\n  border-radius: 4px;\n  outline: 0;\n}\n.hover-effect.mat-button:hover .mat-button-focus-overlay {\n  opacity: 0.3;\n  min-width: 152px;\n}\n@media only screen and (min-width: 1270px) {\n  .logo img {\n    float: right;\n    position: absolute;\n    top: 15%;\n    left: 75%;\n  }\n}\n@media only screen and (min-width: 601px) and (max-width: 1269px) {\n  .logo img {\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n  }\n}\n@media only screen and (max-width: 600px) {\n  .logo img {\n    float: right;\n    position: absolute;\n    top: 15%;\n    left: 50%;\n  }\n}\n@media only screen and (max-width: 370px) {\n  .logo img {\n    display: none;\n  }\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<main class=\"Index\" data-controller=\"IndexFirstSectionHeight, Parallax, IndexNavigation\">\n   <section id=\"resume-header\" class=\"Index-page Index-page--has-image\"  data-parallax-original-element data-edit-main-image=\"Background\">\n      <div class=\"Index-page-content  vba-alternate-block-style-container\">\n         <div class=\"vba-layout vba-grid-12 columns-12\" data-type=\"page\">\n            <div class=\"row vba-row\">\n               <div class=\"col vba-col-12 span-12\">\n                  <div class=\"vba-block html-block vba-block-html\" data-block-type=\"2\">\n                     <div class=\"vba-block-content\">\n                        <h1>Google Maps</h1>\n                        <h4>\n                          Integration the <a href=\"https://github.com/vincentBaylly/GoogleMapsModule\" target=\"_blank\">google maps module</a><br/>\n                          using <a href=\"https://duproprio.com\" target=\"_blank\">duProprio</a> API to add some marker on the maps.<br/>\n                          The call to the api is done with <a href=\"http://expressjs.com/\" target=\"_blank\">express</a>\n                        </h4>\n                     </div>\n                  </div>\n               </div>\n            </div>\n         </div>\n      </div>\n   </section>\n   <section id=\"home-content\" class=\"Index-page\" data-edit-main-image=\"Background\">\n      <div class=\"Index-page-content \">\n        <div class=\"row vba-row\">\n           <div class=\"col vba-col-12 span-12\">\n              <div class=\"vba-block html-block vba-block-html\" data-block-type=\"2\">\n                 <div class=\"vba-block-content\">\n                   <google-maps\n                     [latitude]=\"lat\"\n                     [longitude]=\"lng\"\n                   >\n                   </google-maps>\n                 </div>\n              </div>\n           </div>\n        </div>\n      </div>\n   </section>\n</main>\n"
...
module.exports = "<main class=\"Index\" data-controller=\"IndexFirstSectionHeight, Parallax, IndexNavigation\">\n  <section id=\"resume-header\" class=\"Index-page Index-page--has-image\"  data-parallax-original-element data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content  vba-alternate-block-style-container\">\n      <h1 align=\"center\">SYSTEM SKILLS</h1>\n    </div>\n  </section>\n  <section *ngIf=\"!isMobile\" id=\"sys-diagram-content\" class=\"Index-page\" data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content\">\n      <div class=\"container\">\n        <div class=\"item\" id=\"sysAppDiagram\"></div>\n      </div>\n    </div>\n  </section>\n  <section *ngIf=\"isMobile\" id=\"sys-diagram-content\" class=\"Index-page\" data-edit-main-image=\"Background\">\n    <div class=\"Index-page-content \">\n      <div class=\"container\">\n        <carousel>\n          <ng-container *ngFor=\"let item of items;\">\n            <ng-container *carouselItem>\n              <div class=\"item\" id=\"{{item.id}}\"></div>\n            </ng-container>\n          </ng-container>\n        </carousel>\n      </div>\n    </div>\n  </section>\n</main>\n"
...
/***/ "./src/app/model/mail/mail-config.ts":
/*!*******************************************!*\
  !*** ./src/app/model/mail/mail-config.ts ***!
  \*******************************************/
/*! exports provided: MailConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MailConfig", function() { return MailConfig; });
var MailConfig;
(function (MailConfig) {
    MailConfig["apiKey"] = "YXBpOjIxYzVmMTM4NzJkNjc5YzdhZDI3ZWUzNTQ0MTRiOWY3LTQ5YTI2NzFlLWE2MDM1NjFl";
    MailConfig["domain"] = "sandbox8022e9d68efd4e6cba706203dc61b6c4.mailgun.org";
    MailConfig["to"] = "vincent.baylly@computhand.com";
    MailConfig["subject"] = "[PresentationVincentBaylly - ContactUs] -";
})(MailConfig || (MailConfig = {}));


/***/ }),

/***/ "./src/app/model/mail/mail.ts":
/*!************************************!*\
  !*** ./src/app/model/mail/mail.ts ***!
  \************************************/
/*! exports provided: createMail */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createMail", function() { return createMail; });
/* harmony import */ var _model_mail_mail_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../model/mail/mail-config */ "./src/app/model/mail/mail-config.ts");
...
function createMail(mail) {
    ...
    var mailToSend = { from: '', to: '', name: '', subject: '', text: '' };
    try {
        mailToSend.to = _model_mail_mail_config__WEBPACK_IMPORTED_MODULE_0__["MailConfig"].to;
...
/***/ "./src/app/service/mail/mail.service.ts":
/*!**********************************************!*\
  !*** ./src/app/service/mail/mail.service.ts ***!
  \**********************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _model_mail_mail_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../model/mail/mail-config */ "./src/app/model/mail/mail-config.ts");
...
var httpOptions = {
    headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
        ...
        'Authorization': 'Basic ' + _model_mail_mail_config__WEBPACK_IMPORTED_MODULE_1__["MailConfig"].apiKey,
...
var MailService = /** @class */ (function () {
    ...
    MailService.prototype.sendEmail = function (contactMail) {
        if (contactMail.from && contactMail.subject && contactMail.text) {
            var body = '';
            httpOptions.params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
                .set('from', contactMail.from)
                .set('to', contactMail.to)
                .set('subject', contactMail.subject)
                .set('text', contactMail.text);
            return this.http.post('https://api.mailgun.net/v3/' + _model_mail_mail_config__WEBPACK_IMPORTED_MODULE_1__["MailConfig"].domain + '/messages', body, httpOptions)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (result) { return result; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) { return error; }));
        }
    };
